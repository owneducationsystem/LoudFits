...
export function setupAjaxEmailRoutes(app: Express) {
  // Test sending welcome email
  app.post("/api/ajax/email/welcome", async (req: Request, res: Response) => {
    try {
  ...
  app.post("/api/ajax/email/login", async (req: Request, res: Response) => {
    try {
      const { userId } = req.body;
  ...
  app.post("/api/ajax/email/order", async (req: Request, res: Response) => {
    try {
  ...
  app.post("/api/ajax/email/payment-success", async (req: Request, res: Response) => {
    try {
      const { userId, orderId } = req.body;
  ...
  app.post("/api/ajax/email/payment-failure", async (req: Request, res: Response) => {
    try {
      const { userId, orderId } = req.body;
  ...
  app.post("/api/ajax/email/order-status", async (req: Request, res: Response) => {
    try {
